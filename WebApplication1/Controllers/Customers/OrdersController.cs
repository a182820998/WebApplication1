...
namespace WebApplication1.Controllers.Customers
{
    public class OrdersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OrderId,Memo,CustomerId,ProductId")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrderId,Memo,CustomerId,ProductId")] Order order)
        {
            if (ModelState.IsValid)
            {
